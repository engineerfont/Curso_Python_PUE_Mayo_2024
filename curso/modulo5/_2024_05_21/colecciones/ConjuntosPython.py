...
# Los elementos de un set son único, lo que significa que no puede haber
...
# A diferencia de las listas, en los set no podemos modificar un
# elemento a través de su índice.
s = set([5, 6, 7, 8])
