...
# Elimina los directorios, lanza una excepción si los directorios non existen o están vacíos
...
# Obtiene los archivos y subdirectorios de un directorio, lanza una excepción si el directorio no existe
