# Funciones con argumentos o parámetros de longitud variable
...
# Los parámetros de longitud variable se pueden combinar con parámetros
# por posición
def mostrar(veces, *palabras):
    for p in palabras:
            print("mostrar =>", p.upper() * veces)

mostrar(2, 'primera', 'segunda', 'tercera')
...
# una tupla en parámetros variables
